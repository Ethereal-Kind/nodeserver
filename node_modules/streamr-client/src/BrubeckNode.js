...
const getTrackerRegistryFromContract_1 = require("./getTrackerRegistryFromContract");
/**
 * Wrap a network node.
...
let BrubeckNode = class BrubeckNode {
    ...
    async getNormalizedNetworkOptions() {
        if (this.options.trackers.contractAddress) {
            const trackerRegistry = await (0, getTrackerRegistryFromContract_1.getTrackerRegistryFromContract)({
                contractAddress: this.options.trackers.contractAddress,
