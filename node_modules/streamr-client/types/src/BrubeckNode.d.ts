...
import { BrubeckNodeOptions } from './Config';
...
export default class BrubeckNode implements Context {
    ...
    constructor(context: Context, destroySignal: DestroySignal, ethereum: Ethereum, options: BrubeckNodeOptions);
    private assertNotDestroyed;
    private getNormalizedNetworkOptions;
    private initNode;
    private generateId;
    /**
