...
export declare type SupportedWs = WebSocket | w3cwebsocket;
...
export declare abstract class AbstractClientWsEndpoint<C extends AbstractWsConnection> extends AbstractWsEndpoint<C> {
     ...
     */
    protected handshakeListener(ws: SupportedWs, serverPeerInfo: PeerInfo, serverUrl: string, message: IMessageEvent | string | Buffer | Buffer[], resolve: (value: PeerId | PromiseLike<string>) => void): void;
