...
declare type GetNeighborsFn = (streamPartId: StreamPartID) => ReadonlyArray<NodeId>;
declare type SendToNeighborFn = (neighborId: NodeId, msg: StreamMessage) => Promise<void>;
...
export declare class Propagation {
    private readonly getNeighbors;
    private readonly sendToNeighbor;
    private readonly minPropagationTargets;
    private readonly activeTaskStore;
    constructor({ getNeighbors, sendToNeighbor, minPropagationTargets, ttl, maxMessages }: ConstructorOptions);
    /**
